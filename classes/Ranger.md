...
## Sworn Companion:
  ...
  + you have a companion creature which fights beside you. it has 2 action points and can take a number of forms:
    ...
    + your companion has 12 + 3 per level origin points and can take features and debuffs which could apply to it
...
| arachnid | 7 tiles | 2d4 +2 vitality | makes one free opportunity attack per turn, applies poison on hit (1d4 poison damage per ranger level at start of creatures turn)| 1d4 + 3 | +6 | +3 | +5 |
